					...
					<div class="widget-main">
				       ...
				       <?php
						...
						<div class="form-group <?php echo $date_hope_error; if($rright['ticket_date_hope_disp']==0) echo ' hide ';?>">
							...
							<div class="col-sm-8">
								<input autocomplete="off" type="text" id="date_hope" name="date_hope"  onchange="loadVal();" value="<?php  if ($_POST['date_hope']) echo $_POST['date_hope']; else echo $globalrow['date_hope']; ?>" <?php if($rright['ticket_date_hope']==0) echo 'readonly="readonly"';?>>
								<?php
						...
						<div class="form-group <?php if($rright['ticket_date_res_disp']==0) echo 'hide';?>">
							...
							<div class="col-sm-8">
								<input autocomplete="off" type="text" id="date_res" name="date_res"  value="<?php  if ($_POST['date_res']) echo $_POST['date_res']; else echo $globalrow['date_res']; ?>" <?php if($rright['ticket_date_res']==0) echo 'readonly="readonly"';?>>
							</div>
						</div>
