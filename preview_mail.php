			...
			<div class="card-body p-0">
				<div class="p-3">
					<table class="table table  table-bordered">
						<tbody>
							<tr>
								<td style="width: 150px;" class="text-95 text-default-d3 bgc-secondary-l3"><i class="fa fa-sign-out-alt text-blue-m3 pr-1"></i>'.T_('Émetteur').'</td>
								<td class="text-95 text-default-d3">'.$sender.'</td>
							</tr>
							<tr>
								<td class="text-95 text-default-d3 bgc-secondary-l3"><i class="fa fa-sign-in-alt text-blue-m3 pr-1"></i>'.T_('Destinataire').'</td>
							...
							<tr>
								<td class="text-95 text-default-d3 bgc-secondary-l3"><i class="fa fa-copy text-blue-m3 pr-1"></i>'.T_('Copie').' </td>
								<td class="text-95 text-default-d3">
									';
							...
							if($rparameters['mail_cci'])
							{
								echo '
									<tr>
										<td class="text-95 text-default-d3 bgc-secondary-l3"><i class="fa fa-copy text-blue-m3 pr-1"></i>'.T_('Copie cachée').'</td>
										<td class="text-95 text-default-d3">
							...
							echo '
							<tr>
								<td style="width: 150px;" class="text-95 text-default-d3 bgc-secondary-l3"><i class="fa fa-flag text-blue-m3 pr-1"></i>'.T_('Objet').'</td>
								<td class="text-95 text-default-d3">'.$object.'</td>
							</tr>
							<tr>
								<td style="width: 150px;" class="text-95 text-default-d3 bgc-secondary-l3"><i class="fa fa-file-alt text-blue-m3 pr-1"></i>'.T_('Corps').'</td>
							...
							';
								...
								if(!empty($attachment))
								{
									echo '
									<tr>
										<td style="width: 150px;" class="text-95 text-default-d3 bgc-secondary-l3"><i class="fa fa-file-alt text-blue-m3 pr-1"></i>'.T_('Pièces jointes').'</td>
										<td class="text-95 text-default-d3">
