							...
							<tbody>
								...
								<tr>
									...
									<td class="text-95 text-default-d3">
										...
										<div class="pt-1"></div>
										<label for="restrict_ip"><?php echo T_('Restriction IP'); ?> : </label>
								...
								<tr>
									...
									<td class="text-95 text-default-d3">
										<label for="timeout"><?php echo T_('Temps de déconnexion'); ?> : </label>
											...
											<div class="pt-1"></div>
											<label><i class="fa fa-caret-right text-primary-m2"></i> <a target="_blank" href="./monitor.php?user_id=<?php echo $_SESSION['user_id']; ?>&key=<?php echo $rparameters['server_private_key']; ?>"><?php echo T_('Écran de supervision'); ?></a></label>
									</td>
								</tr>
								<tr>
									<td style="width: 150px;" class="text-95 text-default-d3 bgc-secondary-l3">
								...
								<tr>
									...
									<td class="text-95 text-default-d3">
										<i class="fa fa-caret-right text-primary-m2"></i> <label><?php echo T_("Envoi de mail automatique"); ?> :</label>
										<br />
										<div class="ml-4">
											<label>
										...
										<i class="fa fa-caret-right text-primary-m2"></i> <label><?php echo T_('Texte début du mail'); ?> :</label> <input style="width:auto" class="form-control form-control-sm d-inline-block" name="mail_txt" type="text" value="<?php echo $rparameters['mail_txt']; ?>" size="80" />
										<i title="<?php echo T_('Vous pouvez utiliser du code HTML (Exemple: <br />, <b></b>...)'); ?>" class="fa fa-question-circle text-primary-m2"></i>
										<div class="pt-1"></div>
										<i class="fa fa-caret-right text-primary-m2"></i> <label><?php echo T_('Texte fin du mail'); ?> :</label> <input style="width:auto" class="form-control form-control-sm d-inline-block" name="mail_txt_end" type="text" value="<?php echo $rparameters['mail_txt_end']; ?>" size="83" />
										...
										<div class="pt-1"></div>
										<i class="fa fa-caret-right text-primary-m2"></i> <label><?php echo T_('Adresse en copie'); ?> :</label> <input style="width:auto" class="form-control form-control-sm d-inline-block" name="mail_cc" type="text" value="<?php echo $rparameters['mail_cc']; ?>" size="30" /><br />
										<div class="pt-1"></div>
										<i class="fa fa-caret-right text-primary-m2"></i> <label><?php echo T_("Intitulé de l'émetteur"); ?> :</label> <input style="width:auto" class="form-control form-control-sm d-inline-block" name="mail_from_name" type="text" value="<?php echo $rparameters['mail_from_name']; ?>" size="30" /><br />
										<div class="pt-1"></div>
										<i class="fa fa-caret-right text-primary-m2"></i> <label><?php echo T_("Adresse de l'émetteur"); ?> :</label> <input style="width:auto" class="form-control form-control-sm d-inline-block" name="mail_from_adr" type="text" value="<?php echo $rparameters['mail_from_adr']; ?>" size="30" />
										...
										<div class="pt-1"></div>
										<i class="fa fa-caret-right text-primary-m2"></i> <label><?php echo T_('Couleur du titre'); ?> :</label> #<input style="width:auto" class="form-control form-control-sm d-inline-block" name="mail_color_title" type="text" value="<?php echo $rparameters['mail_color_title']; ?>" size="6" /><br />
										<div class="pt-1"></div>
										<i class="fa fa-caret-right text-primary-m2"></i> <label><?php echo T_('Couleur du fond'); ?> :</label> #<input style="width:auto" class="form-control form-control-sm d-inline-block" name="mail_color_bg" type="text" value="<?php echo $rparameters['mail_color_bg']; ?>" size="6" /><br />
										<div class="pt-1"></div>
										<i class="fa fa-caret-right text-primary-m2"></i> <label><?php echo T_('Couleur du texte'); ?> :</label> #<input style="width:auto" class="form-control form-control-sm d-inline-block" name="mail_color_text" type="text" value="<?php echo $rparameters['mail_color_text']; ?>" size="6" /><br />		
									</td>
								</tr>
								<tr>
									<td style="width: 150px;" class="text-95 text-default-d3 bgc-secondary-l3">
									...
									<td class="text-95 text-default-d3">
										<label> 
											<input type="checkbox" <?php if($rparameters['debug']==1) echo "checked"; ?> name="debug" value="1">
							...
							<tbody>
								<tr>
									...
									<td class="text-95 text-default-d3">
										...
										if($rparameters['mail']==1) 
										{
											echo '
											<div class="pt-1"></div>
											<label for="mail_smtp"><i class="fa fa-caret-right text-primary-m2"></i> '.T_('Serveur SMTP').' :</label>
											...
											<div class="pt-1"></div>
											<label for="mail_port"><i class="fa fa-caret-right text-primary-m2"></i> '.T_('Port SMTP').' :</label>
											...
											<div class="pt-1"></div>
											<label for="mail_ssl_check"><i class="fa fa-caret-right text-primary-m2"></i> '.T_('Vérification SSL').' :</label>
											...
											<div class="pt-1"></div>
											<label for="mail_secure"><i class="fa fa-caret-right text-primary-m2"></i> '.T_('Préfixe SMTP').' :</label>
											<select style="width:auto" class="form-control form-control-sm d-inline-block" id="mail_secure" name="mail_secure" >
											 ...
											 echo '
											<div class="pt-1"></div>
											<label for="mail_smtp_class"><i class="fa fa-caret-right text-primary-m2"></i> '.T_('Classe SMTP').' :</label>
											...
											echo '
												<div class="pt-1"></div>
												&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; '.T_('Utilisateur').' : <input style="width:auto" class="form-control form-control-sm d-inline-block" name="mail_username" type="text" value="'.$rparameters['mail_username'].'" size="30" />
												<div class="pt-1"></div>
												&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; '.T_('Mot de passe').' : <input style="width:auto" class="form-control form-control-sm d-inline-block" name="mail_password" type="password" value="'.$rparameters['mail_password'].'" size="30" />
												';
											}
										}
										?>
								...
								<tr>
									...
									<td class="text-95 text-default-d3">
										...
										<?php if($rparameters['ldap']=='1') 
										{
											...
											<i title="'.T_("Adresse IP ou nom netbios du serveur d'annuaire, sans suffixe DNS (Exemple: 192.168.0.1 ou SVRAD)").'. " class="fa fa-question-circle text-primary-m2"></i><br />
											<div class="pt-1"></div>
											'.T_('Port LDAP').' : 
											...
											echo '
											'.T_('Utilisateur').' : <input style="width:auto" class="form-control form-control-sm d-inline-block" name="ldap_user" type="text" value="'.$rparameters['ldap_user'].'" size="20" />
								...
								<tr>
									...
									<td class="text-95 text-default-d3">
										...
										{
											echo '
												<label for="imap_server"><i class="fa fa-caret-right text-primary-m2"></i> '.T_('Serveur').' IMAP :</label>
												...
												<div class="pt-1"></div>
												<label for="imap_port"><i class="fa fa-caret-right text-primary-m2"></i> '.T_('Protocole').' :</label>
												...
												<div class="pt-1"></div>
												<label for="imap_ssl_check"><i class="fa fa-caret-right text-primary-m2"></i> '.T_('Vérification SSL').' :</label>
												...
												<i title="'.T_('Désactivation de la verification du certificat serveur et autorise les certificats auto-signés').'" class="fa fa-question-circle text-primary-m2"></i>
												<div class="pt-1"></div>
												<label for="inbox"><i class="fa fa-caret-right text-primary-m2"></i> '.T_('Dossier racine').' :</label>
												...
												<div class="pt-1"></div>
												<label for="imap_user"><i class="fa fa-caret-right text-primary-m2"></i> '.T_('Adresse de messagerie').' :</label>
												...
												<div class="pt-1"></div>
												<label for="imap_password"><i class="fa fa-caret-right text-primary-m2"></i> '.T_('Mot de passe').' :</label>
												...
												echo '
												<label for="imap_blacklist"><i class="fa fa-caret-right text-primary-m2"></i> '.T_('Adresses à exclure').' :</label>
												...
												<div class="pt-1"></div>
												<label for="imap_post_treatment"><i class="fa fa-caret-right text-primary-m2"></i> '.T_('Action post traitement').' :</label>
