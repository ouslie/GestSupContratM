...
if($_POST['add'])
{
	$db->exec("INSERT INTO tusers (profile,firstname,lastname,phone,mobile,mail,company) VALUES ('2',$_POST[firstname],$_POST[lastname],'$_POST[phone]','$_POST[mobile]','$_POST[usermail]','$_POST[company]')");
	//redirect
...
if($_POST['modifyuser'])
{
	$db->exec("UPDATE tusers SET lastname=$_POST[lastname], phone='$_POST[phone]', mobile='$_POST[mobile]', mail='$_POST[usermail]', firstname=$_POST[firstname], company='$_POST[company]' where id LIKE $db_edituser");
