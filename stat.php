...
//month & day table 
$mois = array();
$mois = array("01" => T_('Janvier'), "02"=> T_('Février'), "03"=> T_('Mars'), "04"=> T_('Avril'), "05"=> T_('Mai'), "06"=> T_('Juin'), "07"=> T_('Juillet'), "08"=> T_('Août'), "09"=> T_('Septembre'), "10"=> T_('Octobre'), "11"=> T_('Novembre'), "12"=> T_('Décembre'));
$jour= array();
