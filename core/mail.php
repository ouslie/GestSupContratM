			...
			<font face="Arial">
				<table width="700" cellspacing="0">
					<tr bgcolor="'.$rparameters['mail_color_title'].'" >
					  <th style="padding:10px;" ><span style="font-size: large; color: #FFFFFF;"> &nbsp; '.$objet.' &nbsp;</span></th>
					</tr>
					<tr bgcolor="'.$rparameters['mail_color_bg'].'" >
					  <td style="padding:10px;" >
						...
						<br />
						<br />
						<table border="1" bordercolor="'.$rparameters['mail_color_title'].'" cellspacing="0" >
							<tr>
								<td style="padding:5px;"><font color="'.$rparameters['mail_color_text'].'"><b>'.T_('Titre').' :</b> '.$globalrow['title'].'</font></td>
								<td style="padding:5px;"><font color="'.$rparameters['mail_color_text'].'"><b>'.T_('Catégorie').' :</b> '.$catrow['name'].' - '.$subcatrow['name'].'</font></td>
							</tr>
							<tr>
								';
								//detect user group  
								if ($globalrow['u_group']!=0)
								{$msg.='<td style="padding:5px;" width="400"><font color="'.$rparameters['mail_color_text'].'"><b>'.T_('Demandeur').' :</b> '.$groupuser['name'].'</font></td>';}
								else
								{$msg.='<td style="padding:5px;" width="400"><font color="'.$rparameters['mail_color_text'].'"><b>'.T_('Demandeur').' :</b> '.$userrow['lastname'].' '.$userrow['firstname'].'</font></td>';}
								//detect technician group  
								if ($globalrow['t_group']!=0)
								{$msg.='<td style="padding:5px;" width="400"><font color="'.$rparameters['mail_color_text'].'"><b>'.T_('Groupe de technicien en charge').' :</b> '.$grouptech['name'].'</font></td>';}
								else
								{$msg.='<td style="padding:5px;" width="400"><font color="'.$rparameters['mail_color_text'].'"><b>'.T_('Technicien en charge').' :</b> '.$techrow['lastname'].' '.$techrow['firstname'].'</font></td>';}
								$msg.='
							</tr>
							<tr>
								<td style="padding:5px;" ><font color="'.$rparameters['mail_color_text'].'"><b>'.T_('État').' :</b> '.T_($staterow[0]).'</font></td>
								<td style="padding:5px;" ><font color="'.$rparameters['mail_color_text'].'"><b>'.T_('Date de la demande').' :</b> '.$date_create.'</font></td>	
							</tr>
							'.$place;
							...
							if($rparameters['mail_order']==1)
							{
								$msg.='
									<tr>
										<td style="padding:5px;"  colspan="2"><font color="'.$rparameters['mail_color_text'].'"><b>'.T_('Résolution').' :</b><br />'.$resolution.'</font></td>
									</tr>
									<tr>
										<td style="padding:5px;"  colspan="2"><font color="'.$rparameters['mail_color_text'].'"><b>'.T_('Description').' :</b><br />'.$description.'</font></td>
									</tr>
								';
							} else {
								$msg.='
