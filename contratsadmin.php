...
?>
				...
				<div class="form-group">
					<label class="col-sm-2 control-label no-padding-right" for="">
						<?php echo T_('Type de contrat'); ?>:</label>
					</label>
					<div class="col-sm-8">
						<?php
...
?>
				...
				<div class="form-group">
					<label class="col-sm-2 control-label no-padding-right" for="">
						<?php echo T_('Date de début'); ?>:</label>
					<div class="col-sm-8">
				...
				<div class="form-group">
					<label class="col-sm-2 control-label no-padding-right" for="">
						<?php echo T_('Temps souscrit en min'); ?>:</label>
					<div class="col-sm-8">
				...
				<div class="form-group">
					<label class="col-sm-2 control-label no-padding-right" for="">
						<?php echo T_('Montant par heure'); ?>:</label>
					<div class="col-sm-8">
				...
				<div class="form-group">
					<label class="col-sm-2 control-label no-padding-right" for="">
						<?php echo T_('Tarif Contrat'); ?>:</label>
					<div class="col-sm-8">
				...
				<div class="form-group">
					<label class="col-sm-2 control-label no-padding-right" for="">
						<?php echo T_('Prepayé'); ?>:</label>
					<div class="col-sm-8">
						<input type="checkbox" id="prepaye" name="prepaye">
					</div>
				</div>
				<br></br>
				<div class="form-group">
...
if ($rright['admin_contrat'] != 0) {
    ...
    function addcontrat()
    {
        ...
        $query = "INSERT INTO tcontrats (user, status, date_souscription, date_fin, temps_souscrit, tarif, tarifcontrat, type, periode,nom,prepaye) VALUES ('$demandeur', '1' , STR_TO_DATE('$date_debut', '%d/%m/%Y'),STR_TO_DATE('$date_fin', '%d/%m/%Y'), '$temps_souscrit', '$montantheure','$tarifcontrat', '$type', '$periode','$service','$prepaye')";
        $query = $db->query($query);
    ...
    function cloturecontrat()
    {
        ...
        if ($typecontrat == 2) {
			...
			echo $id_facture;
			$query = "UPDATE tcontrats SET facturelink = 'https://gestion.arnaudguy.fr/facture.php?id_fact=$id_facture' WHERE id='$var'";
			$query = $db->query($query);
...
<div class="page-header position-relative">
	<h1><i class="icon-briefcase"></i>
		<?php echo T_('Contrats'); ?>
	</h1>
...
selectcontrat($view);
        ...
        while ($row = $query->fetch()) {
            ...
            echo $row['lastname']; ?>
						...
						<td>
							<?php echo $row['nomtype']; ?>
						</td>
						<td>
							<?php echo $row['nomcontrat']; ?>
						</td>
						<td>
							<?php echo $row['nomperiode']; ?>
						</td>
						<?php if ($view == 1 || $view == 4) {
                echo "<td>";
                echo $row['prepaye'];
                echo "</td>";
						...
						<td>
							<?php echo $row['date_souscription']; ?>
						</td>
						<td>
                ...
                echo "€";
						...
						<td>
							<?php if (!empty($row['facturelink'])) {?> <a href="<?php echo $row['facturelink']; ?>" target=_blank>
