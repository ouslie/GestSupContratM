...
<div class="row">
	...
	if($rright['task_checkbox'] && $resultcount[0]>0)
	{
		echo '
			...
			<select style="width:auto" class="form-control form-control-sm" title="'.T_('Effectue des actions pour les tickets sélectionnés dans la liste des tickets').'." name="selectrow" onchange="if(confirm(\''.T_('Êtes-vous sûr de réaliser cette opération sur les tickets sélectionnés').'?\')) this.form.submit();">
