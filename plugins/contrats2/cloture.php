...
EOD;
        ...
        $hash = WebserviceFacture($useridfacture, $designation, $tarifcontrat, $webservice['token'], 1, $webservice['url'], 46);
        echo $hash;
        $facturelink .= $hash;
        ...
        $messages .= "Retouvez vos tickets et factures sur <a href='https://support.arnaudguy.fr'>support.arnaudguy.fr</a><br/>";
...
EOD;
        ...
        $hash = WebserviceFacture($useridfacture, $designation, $tarif, $webservice['token'], $quantity, $webservice['url'], 44);
        echo $hash;
        $facturelink .= $hash;
        $query = "UPDATE tcontrats SET facturelink = '$facturelink' WHERE id='$var'";
        $query = $db->query($query);
        ...
        $messages .= "Vous trouverez ci-dessous le lien pour la facture : </br>";
        $messages .= "<a href=$facturelink> Ma facture</a> </br> </br>";
        $messages .= "Retouvez vos tickets et factures sur <a href='https://support.arnaudguy.fr'>support.arnaudguy.fr<br/></a>";
        $messages .= "Je reste à votre disposition,</br>";
        $messages .= "Arnaud GUY</br>";
        $messages .= "www.arnaudguy.fr</br>";
